...
public class LoginMenu extends Menu {
    ...
    public LoginMenu(Scanner scan) {
        ...
        //// add commands here
        addCommand(Regex.LOGIN_CREATE_USER, matcher -> {
            try {
                register(matcher);
            } catch (IOException e) {
        ...
        addCommand(Regex.LOGIN_CREATE_USER_WITH_PASSWORD, matcher -> {
            try {
                registerWithPassword(matcher);
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
        });
    ...
    private void registerWithPassword(Matcher matcher) throws IOException {
    ...
    private void checkValidRegister(String username, String password,String confirmPassword, String email, String nickname) throws IOException {
